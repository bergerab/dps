...
*** Development Setup
Rename ./docker/.env.dev-sample to ./docker/.env.dev and update the environment variables.
...
*** Production Setup
Rename ./docker/.env.prod-sample to ./docker/.env.prod and update the environment variables.
